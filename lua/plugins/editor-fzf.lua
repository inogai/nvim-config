return {
  {
    ...
    keys = {
      ...
      { '<leader>sh', function() FzfLua.helptags({ fzf_opts = { ['--query'] = vim.fn.expand('<cword>') } }) end, desc = 'Help Pages' },
      { '<leader>sh', function() FzfLua.helptags({ fzf_opts = { ['--query'] = Utils.expand_visual() } }) end, desc = 'Help Pages', mode = { 'v' } },
